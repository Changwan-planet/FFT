...
#fft data-Otput_2
output_path="/home/changwan/FFT/FFT_GPR_output.txt"    #fft result from the Foran90 code
...
#FFT result from sun
plt.subplot(4,3,4)
plt.plot(Output_2["fft_real_from_sun"].loc[0:S/2],'r',label='from Sun')
plt.plot(Output_2["fft_real_from_scipy"].loc[0:S/2],'b',label = 'from sci_py')
plt.title("fft_real")
...
plt.subplot(4,3,5)
plt.plot(Output_2["fft_imag_from_sun"].loc[0:S/2],'r',label='from Sun')
plt.plot(Output_2["fft_imag_from_scipy"].loc[0:S/2],'b',label = 'from sci_py')
plt.title("fft_image")
#plt.xticks(xt,(i*f_sam_in for i in xt))
plt.legend()
plt.grid()
...
plt.subplot(4,3,6)
plt.plot(Output_2["fft_magnitude_from_sun"].loc[0:S/2],'r',label='from Sun')
plt.plot(Output_2["fft_magnitude_from_scipy"].loc[0:S/2],'b',label = 'from sci_py')
...
plt.subplot(4,3,7)
plt.plot(Input2_2["ifft_real_from_sun"], 'r',label='from Sun')
...
plt.subplot(4,3,8)
plt.plot(Input2_2["ifft_imag_from_sun"],'r', label='from Sun')
